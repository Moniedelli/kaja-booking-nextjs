        ...
        <div className="drawer lg:drawer-open">
          ...
          <div className="max-w-xl">
            ...
            <ul className="menu p-4 min-h-full  text-zinc-300">
              ...
              <Link href="/admin"><li><a className={isActiveRoute('/admin') ? 'bg-zinc-900' : ''}>
              ...
              <Link href="/admin/userAccount"><li><a className={isActiveRoute('/admin/userAccount') ? 'bg-zinc-900' : ''}>
                <div className='flex justify-start gap-2 py-1 pr-10'>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
              ...
              <Link href="/admin/admins"><li><a className={isActiveRoute('/admin/admins') ? 'bg-zinc-900' : ''}>
                <div className='flex justify-start gap-2 py-1 pr-10'>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
              ...
              <Link href="/admin/transaction"><li><a className={isActiveRoute('/admin/transaction') ? 'bg-zinc-900' : ''}>
                <div className='flex justify-start gap-2 py-1 pr-10'>
              ...
              <Link href="/admin/content"><li><a className={isActiveRoute('/admin/content') ? 'bg-zinc-900' : ''}>
                <div className='flex justify-start gap-2 py-1 pr-10'>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
              ...
              {/* <Link href="/admin/inbox"><li><a className={isActiveRoute('/admin/inbox') ? 'bg-zinc-900' : ''}>
                <div className='flex justify-start gap-2 py-1 pr-10'>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
